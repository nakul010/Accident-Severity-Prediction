...
# predict the target from all the input features
       ...
       st.write("Developed By: Nakul Gupta")
       st.markdown("Please find GitHub repository link of project: [Click Here](https://github.com/nakul010/Accident-Severity-Prediction)")          
